...
set _xil_proj_name_ "EISLER_A7_XADC"
...
set_property -name "dsa.board_id" -value "fab-tech-a7" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/srcs/sources_1/new/xadc_top.sv" ]\
 [file normalize "${origin_dir}/srcs/sources_1/new/SEVEN_SIGMENT.vhd" ]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "new/SEVEN_SIGMENT.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

# Set 'sources_1' fileset file properties for local files
set file "new/xadc_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "xadc_top" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/srcs/sources_1/ip/xadc_wiz_0/xadc_wiz_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
